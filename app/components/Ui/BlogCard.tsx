        ...
        <Link href={`/blogs/${post.slug}`} passHref>
            ...
            >
                ...
                <div className="p-6 flex flex-col h-full">
                    ...
                    {/* Visual CTA - (Using a div/span here because it's already inside a Link) */}
                    <div className="pt-2 mt-auto flex items-center gap-2 text-[11px] font-sans font-bold tracking-widest uppercase text-navy-900 group-hover:text-gold-500 transition-all duration-300">
