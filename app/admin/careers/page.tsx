...
import {
  ...
  ViewResumeModal,
  DeleteConfirmModal,
} from "@/app/admin/components/ApplicationModals";
...
export default function CareerApplications() {
  ...
  const handleDelete = () => {
    if (deleteModal.applicationId) {
      deleteApplication.mutate(deleteModal.applicationId, {
        onSuccess: () => {
          setDeleteModal({
            open: false,
            applicationId: null,
...
{/**view details modal */}
        ...
        <ViewDetailsModal
          ...
          onClose={() => setViewModal({ open: false, application: null })}
        />
      )}
      ...
      {resumeModal.open && (
        <ViewResumeModal
          ...
          onClose={() => setResumeModal({ open: false, resumeUrl: null })}
        />
      )}
