...
const propertyData: PropertyDetail = {
    ...
    status: "For Sale",
    description:
        "Experience unparalleled luxury in this stunning penthouse suite located in the heart of Manhattan. With breathtaking panoramic views of the city skyline, this residence offers the perfect blend of sophisticated design and modern comfort. Floor-to-ceiling windows flood the space with natural light, while premium finishes and state-of-the-art appliances create an atmosphere of refined elegance.",
    features: [
    ...
    agent: {
        ...
        email: "sarah.mitchell@luxury-estates.com",
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        >
                            <div className="flex items-start justify-between mb-4">
                                <div>
                                    <h1 className="text-4xl md:text-5xl font-bold text-navy-900 font-display mb-2">
                                        {propertyData.title}
                                    </h1>
                                ...
                                <div className="text-right">
                                    <p className="text-sm text-navy-900/40 uppercase tracking-wider mb-1">
                                        Price
                                    </p>
                        ...
                        <motion.div
                            ...
                            className="bg-white border border-gold-500/20 rounded-2xl p-8 backdrop-blur-sm"
                        >
                            <SectionLabel>Building Amenities</SectionLabel>
                            <div className="grid md:grid-cols-2 gap-4 mt-6">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        >
                            ...
                            <div className="mt-6 text-center">
                                ...
                                <p className="text-gold-500/80 text-sm">Luxury Real Estate Agent</p>
                            </div>
                            ...
                            <div className="mt-6 space-y-3">
                                <motion.button
                                    whileHover={{ scale: 1.02 }}
                                    whileTap={{ scale: 0.98 }}
                                    className="cursor-pointer w-full px-6 py-3 bg-navy-900 border border-gold-500/30 text-white rounded-lg font-semibold hover:bg-navy-900 transition-colors flex items-center justify-center gap-2"
                                >
                                    <svg
                                        className="w-5 h-5"
                                        fill="none"
